...
const SuperQuality = () => {
  return (
    ...
    gap-10 w-full max-container">
      ...
      flex-col">
        <h2 
          className="mt-10 font-palanquin text-4xl capitalize
        ...
        Ensuring premium comfort and style, pur meticulously
        crafted footwear is designed to elevate
        your experience, providing you with
        unmatched quality, innovation and a
        touch of elegance.
        </p>
